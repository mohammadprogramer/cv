...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/anitabs.css">

  <!-- style -->
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/magic-mouse.css">
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style.css">
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style-dark.css">
  <!-- responsive -->
...
<!-- loader end-->
	...
	<header class="pages-one">
		...
		<div class="mobile-nav" id="mobile-nav" style="display: block;">
            		...
            		<img alt="logo" src="<?php echo get_template_directory_uri(); ?>/img/orix-logo.png">
            	</a>
            </div>
	            <ul class="menu-item main-menu tabs-nav__list">
	          ...
	          <a href="JavaScript:void(0)" id="res-cross"></a>
	           ...
	           <a href="<?php echo get_template_directory_uri(); ?>/pdf/orix.pdf" class="magic-hover magic-hover__square button download  button--moema button--text-thick button--text-upper button--size-s" target="_blank"><i class="fa-solid fa-download"></i>Download CV</a>
				...
				<div class="col-lg-4">
						<div class="user-info">
							...
							<ul class="social-media">
								<li><a class="magic-hover magic-hover__square" href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
								<li><a class="magic-hover magic-hover__square" href="#"><i class="fa-brands fa-twitter"></i></a></li>
								<li><a class="magic-hover magic-hover__square" href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
					...
					<div class="row">
						<div class="col-xl-8 col-lg-12">
								...
								<ul class="fun-facts">
									...
									<li class="time">
										<h2 class="timer count-title count-number" data-to="256" data-speed="1500">256</h2>
										<span>+</span>
										<p>Years Of Experience</p>
									</li>
									<li class="time">
										<h2 class="timer count-title count-number" data-to="09" data-speed="1500">09</h2>
										<span>+</span>
										<p>Years Of Experience</p>
									</li>
								</ul>
								...
								<div class="headings clients-reviews">
									...
									<div class="photo owl-carousel owl-theme">
											<div class="quote item" data-hash="zero">
												<img alt="quote" src="<?php echo get_template_directory_uri(); ?>/img/quote.png">
												<div>
													<h6>We help our clients from the definition of their 
															...
															<a class="magic-hover magic-hover__square" href="#">Edison Cavani</a>
											...
											<div class="quote item" data-hash="for">
												<img alt="quote" src="<?php echo get_template_directory_uri(); ?>/img/quote.png">
												<div>
													<h6>We help our clients from the definition of their 
															strategy to the realization of their digital ecosystem. 
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 col-sm-6">
											<div class="client">
												...
												<a href="#" class="magic-hover magic-hover__square">www.winsfolio.net</a>
											</div>
										</div>
										<div class="col-lg-4 col-md-6 col-sm-6">
											<div class="client">
									...
									<div class="portfolio-detail">
										<div class="portfolio-img hover06">
											<figure>
											  ...
											  <a class="magic-hover magic-hover__square" href="portfolio-details-1.html">List of Brands</a>
											  <p>Digital Web</p>
										</div>
									</div>
								</div>
									...
									<div class="portfolio-detail">
										<div class="portfolio-img hover06">
											<figure>
											  ...
											  <a class="magic-hover magic-hover__square" href="portfolio-details-1.html">Mice Goofballs.</a>
											  <p>Branding</p>
										</div>
									</div>
								</div>
									...
									<div class="portfolio-detail">
										<div class="portfolio-img hover06">
											<figure>
											  ...
											  <a class="magic-hover magic-hover__square" href="portfolio-details-1.html">Mobile Development</a>
											  <p>Digital Web</p>
										</div>
									</div>
								</div>
									...
									<div class="portfolio-detail">
										<div class="portfolio-img hover06">
											<figure>
											  ...
											  <a class="magic-hover magic-hover__square" href="portfolio-details-1.html">Grid Mockup</a>
											  <p>Motion</p>
										</div>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-xl-8 col-lg-12">
							...
							<div class="news-img">
								<div class="news-data gapp">
									<p>Digital Marketing, Marketing</p>
									<a class="magic-hover magic-hover__square" href="#">How to find your first job 
															out of college</a>
											<div class="news-img-girl">
														<img alt="girl" src="https://via.placeholder.com/60x60">
														<div>
							...
							<div class="row">
								<div class="col-lg-6">
										<div class="contact-info">
											...
											<a class="magic-hover magic-hover__square" href="callto:+1234483060">1234483060</a>
											<a class="mail" href="mailto:username@domainname.com">username@domainname.com</a>
...
<div class="backdrop"></div>
	<div class="box">
		<div class="flex-img">
		  <img alt="popup-img" src="<?php echo get_template_directory_uri(); ?>/img/orix-popup.jpg">
		  <div class="your-name">
					<h5>Have Question?</h5>
						<form class="one">
...
<!-- popup end -->
	...
	<!-- aos -->
	<script src="<?php echo get_template_directory_uri(); ?>/js/anitabs.min.js"></script>
	...
	<script src="<?php echo get_template_directory_uri(); ?>/js/isotope-init.js"></script>
	<!-- custom -->
